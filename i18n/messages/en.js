export default {
  actions: {
    ...
    course: {
      ...
      deleteInProgress: 'Deleting course {name}...',
      archiveInProgress: 'Archiving course {name}...',
      unarchiveInProgress: 'Unarchiving course {name}...'
    },
    lectureVisibility: {
      lecture: 'Lecture Visibility'
    }
  },
  openAi: {
    title: 'Open AI',
  ...
  toast: {
    ...
    courseSaveAndNotifySuccess: 'Course successfully saved and the learners were notified',
    courseCreatedSuccess: 'Course {name} successfully created!',
    courseCreatedError: 'There was an error creating a course {name}: {err}',
    ...
    courseArchiveSuccess: 'Course {name} successfully archived',
    courseUnarchiveSuccess: 'Course {name} successfully unarchived',
    courseDeleteError: 'There was an error deleting the course',
    courseArchiveError: 'There was an error archiving the course',
    ...
    giveUpWithSuccess: 'The course {name} was given up with success',
    giveUpError: 'There was an error giving up the course {name}: {err}',
    reactivateWithSuccess: 'The course {name} was reactivated with success',
    reactivateError: 'You already have another instance of the same course running. Complete or abandon that one first.',
    archiveSuccess: 'The course {name} was successfully archived',
    archiveError: 'There was an error archiving the course {name}: {err}',
    unArchiveSuccess: 'The course {name} was successfully unarchived',
    unArchiveError: 'There was an error unarchiving the course {name}: {err}',
    certificateCantBeOpen: 'There was an error fetching certificate with uuid {uud}: {err}',
    courseTranslationSuccess: 'The course {name} was translated successfully.',
    courseTranslationError: 'There was an error translating course {name}: {err}',
    resetTimerSuccess: 'Question timer reset with success',
    tagDeleteSuccess: 'Tag {name} successfully deleted',
    tagDeleteError: 'There was an error deleting the tag {name}: {err}',
    defaultSaveError: 'An error occurred while saving the {name}',
    forceSaveError: {
      CANNOT_DELETE_ALL_MODULES: 'You are about to delete all modules of the course. This action can\'t be undone. Are you sure you want to proceed?',
      CANNOT_DELETE_LEARNING_STEP: 'There\'s user progress on steps you are about to delete. This action can\'t be undone. Are you sure you want to proceed?',
      CANNOT_DELETE_LECTURES: 'There\'s user progress on lectures you are about to delete. This action can\'t be undone. Are you sure you want to proceed?',
      CANNOT_DELETE_QUESTION_ANSWER: 'There\'s user progress on quizzes you are about to delete. This action can\'t be undone. Are you sure you want to proceed?',
      CANNOT_DELETE_SECTION: 'There\'s user progress on course sections you are about to delete. This action can\'t be undone. Are you sure you want to proceed?',
      CANNOT_DELETE_LEVELS: 'There\'re skills associated with users on assets you are about to delete. This action can\'t be undone. Are you sure you want to proceed?',
      CANNOT_DELETE_GROUP: 'You are about to delete a group that has assets (users, courses, or learning paths) associated with it. All these links will be lost. Are you sure you want to proceed?',
      DEFAULT: 'There\'s user progress on assets you are about to delete. This action can\'t be undone. Are you sure you want to proceed?'
    }
  },
  ...
  forum: {
    ...
    globalUsers: {
      ...
      selectUser: 'Select a user to comment with'
    }
  },
  dialogs: {
    ...
    confirmationDialog: {
      ...
      confirmQuitScormCourse: {
        title: 'Do you really want to exit the course?',
        subtitle: 'Don\'t worry! You can resume from where you left off.',
        confirmButton: 'Yes, exit now'
      },
      confirmQuitScormLecture: {
        title: 'Are you sure you want to quit the lecture?',
        subtitle: 'Don\'t worry! You can resume the lecture from where you left off.',
        confirmButton: 'Yes, exit now'
      }
    }
  },
  ...
  dashboard: {
    ...
    searchCourseFolders: 'Search course folders',
    filters: {
      searchLearningPaths: 'Search learning paths',
      search: {
  ...
  quiz: {
    ...
    questionPoints: 'Possible points: {points}',
    questionTimerTimeUp: 'Time\'s up! You didn\'t complete the question in the allotted time. Please contact your administrator for assistance.',
    questionTimerMessage: 'You have <strong class="primary--text">{time}</strong> to complete this question. Make sure you\'re ready before you begin.',
    feedback: {
      correct: 'Correct',
      incorrect: 'Incorrect',
  ...
  courseTree: {
    ...
    practicalInfo: {
      availableFrom: 'This course starts on:',
      availableFromPast: 'This course started on:',
      availableUntil: 'This course finishes on:',
      availableUntilPast: 'The registration until:',
      expiresIn: 'This course expires on:',
      doesntExpire: 'This course never expires',
      courseDuration: 'The length of this course:',
      startedCourse: 'You have enrolled into this course on:',
      quizzesText: 'This course has:',
      numberOfQuestions: 'No points | {n} point | {n} points',
    ...
    lectureIsNotDoneExplanation: 'Mark lecture as seen and answer the lecture questions to proceed to the next one',
  ...
  buttons: {
    ...
    open: 'Open',
    new: 'New!',
    exploreCourse: 'Review Course',
    testCertificate: 'Show Certificate',
    printableVersion: 'Open Printable Version',
    clone: 'Clone',
    resume: 'Resume Course',
    enroll: 'Enroll',
    enrollAndPay: 'Enroll and Pay',
    ...
    viewAllCourses: 'All courses',
    viewAllTopics: 'All topics',
    viewMyDashboard: 'My Dashboard',
    viewMyCourses: 'My Courses',
    topNewCourses: 'Latest Courses',
    ...
    lectureSeen: 'You\'ve seen this lecture',
    ...
    translateCourse: 'Translate course',
  ...
  courses: {
    ...
    noCourses: 'You\'re not enrolled in any course yet. Check the course catalogue page.',
    goToDashboard: 'Check your dashboard for your courses',
    ...
    badge: {
      ...
      archived: 'archived',
      inactive: 'inactive',
      paymentMissing: 'payment missing'
    },
    paidCourses: {
      ...
      checkYourSettings: 'Check your country and Tax ID settings',
      confirmSettingsAndProceed: 'Confirm Settings and Proceed',
      wrongTaxId: 'Wrong Tax Id Format. The correct format is <strong>{correctFormat}</strong>.<br>Refresh the page and try again.'
    },
    failedCourse: {
      failedCourseTitle: 'Important Update on Your Course',
      failedCourseTooltip: 'Please restart the course to be able to complete it',
    ...
    headers: {
      title: 'Course Title',
      titleAndDescription: 'Course Title and Description',
      description: 'Course Description',
      ordering: 'Course Order',
      createTime: 'Created',
      updateTime: 'Updated',
      progress: 'Questions Progress',
      quizProgress: 'Questions Progress',
      lecturesProgress: 'Lectures Progress'
    },
    published: 'Published'
  },
  learningPaths: {
  ...
  courseFolders: {
    ...
    selectFolderPlaceholder: 'Select course\'s folder',
    ...
    totalFound: 'No course folders found | <strong>{n}</strong> course folders found | <strong>{n}</strong> course folders found',
    noCourseFoldersFound: 'No Folders Found',
    folderCourses: 'No courses | {n} course | {n} courses | {n} courses',
    item: {
      titleAndDescription: 'Title and Description',
      noCourses: 'Number of Courses',
      actions: 'Actions'
    }
  },
  auth: {
    ...
    loginWithOCID: 'Login with OC ID',
    createNewWorkspace: 'Or create a new workspace'
  },
  errors: {
    ...
    1307: 'There\'s a cooling-off period of <strong>{period}</strong> before you can take this course again',
    1308: 'Enrollment not possible: You have already completed this course, and enrollment is limited to one time only.'
  },
  footer: {
    ...
    contactUsText: 'If you have any questions or you find an error in a course, write to us!',
    supportEmail: 'support@theworkademy.com',
    poweredBy: 'powered by <a href="{companyUrl}" target="_blank" class="company-link">{company}</a>'
  },
  progress: {
    ...
    questionsProgress: 'You answered {progress}% of questions ({correct}/{total})',
    lecturesProgress: 'You read {progress}% of lectures ({correct}/{total})',
    overallProgress: 'You answered {progressQuestions}% ({correctQuestions}/{totalQuestions}) of questions and read {progressLectures}% ({correctLectures}/{totalLectures}) of lectures.'
  },
  settings: {
    settings: 'Settings',
  ...
  certificates: {
    congratulations: 'Congratulations, you\'ve qualified for a certificate!',
    ...
    youCanCancel: '👉 You can continue your course now and claim your certificate later. The claim option will remain available.',
    checkNameText: '⚠️ Attention! Ensure your certificate name in settings is correct:',
    changeNameInSettingsText: 'To correct the name, use <strong>Change Name</strong> button and then return here.',
    generateForName: 'I confirm issuing the certificate to <strong>{name}</strong>.',
    ...
    reactivateDialogMessage: 'This course has an associated certificate. Proceeding will delete it, and this action cannot be undone. Are you sure you want to continue?',
    abandonCourse: 'Abandon Course',
    dontGenerate: 'Cancel',
    certificateTitle: 'CERTIFICATE OF COMPLETION',
    issuedOn: 'Issue date:',
    toCertifyThat: 'to state that',
    hasCompletedTheCourse: 'has completed the course',
    hasCompletedTheLearningPath: 'has completed the learning path',
    progress: 'progress',
    ...
    canGetCertificateLectures: 'You have read <strong>{score}</strong> out of <strong>{total}%</strong> of the lectures. <br>You can get your certificate.',
    needMoreToGetCertificateLectures: 'You need to complete <strong>{total}%</strong> of the lectures. <br> You have completed <strong>{score}</strong> so far.',
    canGetCertificateBoth: 'You have correctly answered <strong>{totalScore}%</strong> of the questions and completed <strong>{totalLectures}%</strong> of the lectures. <br>You can get your certificate.',
    needMoreLectures: 'You have answered enough questions to qualify, but you need to complete <strong>{totalLectures}%</strong> of the lectures. <br>You\'ve completed <strong>{score}</strong> so far.',
    needMoreQuestions: 'You have completed enough lectures to qualify, but you need to answer <strong>{totalScore}%</strong> of the questions correctly. <br>You\'ve answered <strong>{score}</strong> correctly so far.',
    needMoreQuestionsAndLectures: 'To qualify for the certificate, you need to answer <strong>{totalScore}%</strong> of the questions correctly and complete <strong>{totalLectures}%</strong> of the lectures. <br>You\'ve answered <strong>{score}</strong> questions correctly and completed <strong>{lecturesSeen}</strong> of the lectures so far.',
    ...
    youHaveAlreadyCompleted: 'You have completed this course',
    youCompletedCertification: 'You have completed this certification',
    ...
    cantFind: 'The certificate with UUID {uuid} could not be found.',
    proceedToMainPage: 'Proceed to the main page',
    youHaveToCompleteExternalCourse: 'Click the button once you\'ve completed the course.',
    youHaveCompletedExternalCourse: 'You have already marked this course as completed',
    finishExternalCourseTitle: 'Confirm Course Completion',
    finishExternalCourseSubtitle: 'By clicking the "Complete Course" button, you confirm that you have completed this course. If you have not finished, please select "Cancel" to return and continue the course.'
  },
  vouchers: {
  ...
  admin: {
    ...
    enroll: {
      ...
      grantFreebieButton: 'Grant Access',
      grantFreebieSuccess: 'User {name} was granted access to the course',
      grantFreebieError: 'There was an error granting access to the user {name}: {err}'
    },
    stepper: {
      ...
      globalTopicTitlePlaceholder: 'Type global topic title',
      comments: 'comments',
      ...
      scormBeingProcessed: 'SCORM uploaded! We\'re now processing it, which may take up to two minutes. Feel free to wait or come back later. <strong>Remember to save your course!</strong>',
      scormProcessedSuccessfully: 'SCORM processed successfully!',
      scormProcessedError: 'There was an error processing SCORM file. Try uploading again.',
      oneTimeEnrollment: 'One Time Enrollment',
      titleErrorMessage: 'Course Title is required',
      availablePeriodErrorMessage: 'Finish date cannot be earlier than start date.',
      popup: {
        title: 'Title',
        subtitle: 'Subtitle',
        content: 'Content',
      ...
      recurring: {
        ...
        updateRecurring: 'Update recurring information',
      ...
      aggregated: {
        metadata: 'Metadata (title, description, cover, duration, tags, order)',
        achievements: 'Achievements (certificate, frames, points)',
        courseAccess: 'Course Access and Availability (enrolment codes, start and finish dates, anonymous, paid)',
        socialLearning: 'Social Learning (discussion forum)',
    ...
    newCourse: {
      ...
      createNewCertificationCourse: 'Create new certification course',
      newExternalResource: 'Create new external resource',
      newAiCourse: 'Create new course with help of AI',
      ...
      comingSoon: '(coming soon)',
      certificationTitle: 'Create a Certification Course',
      certificationSubtitle: 'Launch a program focused on certification and assessments',
      certificationCaption: '(Ideal for certification programs!)',
      ...
      createScormCourse: 'Import a SCORM course package',
      lookingLikeCourseCard: 'It will look like a normal course card',
      scormCourseDescription: 'Create a course and upload your SCORM package',
      scormCourseCaption: '(Or replace the URL of the SCORM file)',
      ...
      usingAiTitle: 'Create course outline with AI 🪄',
      aiCourseBeingGenerated: 'Generating your course...\n' +
        'You can wait until it\'s ready, or check it later under "Manage Courses". You can close this window now.',
      usingAiDescription: 'Generate a course outline by typing instructions into a prompt.',
      usingAiCaption: '(I am feeling lucky!)',
    ...
    editExistingFolders: 'Manage Existing Course Folders',
    ...
    quiz: {
      ...
      mandatoryExplanation: 'The learner must answer this question in order to proceed (works together with sequential learning).',
      openAnswer: {
        evaluateOpenAnswerOf: 'Evaluate open-ended answer of {user}',
        answer: 'Answer',
        ...
        openInNew: 'Open in a popup',
        questionTitle: 'Question',
        feedbackTitle: 'Feedback',
        changeFeedback: 'Change feedback',
        provideFeedback: 'Provide a feedback',
        addFeedback: 'Add feedback without grading',
        gradeAnswerButtonCaption: 'When you grade the answer, the feedback (if provided) will be sent as well'
      }
    },
    editingMode: {
      editCourse: {
      ...
      lecture: {
        ...
        topOfTheLectureHeader: 'Top of the Lecture (Cover Image, Video, Typeform, SCORM, or Live Lecture)',
        editLectureHeader: 'Top of the Lecture',
        noHeader: 'no header',
        ...
        invalidPdfUrl: 'Invalid PDF URL (must have a .pdf extension)',
        lectureVisibility: {
          title: 'Configure Lecture Visibility Rules',
          buttonText: 'Change Lecture Visibility',
          dialog: {
            title: 'Lecture Visibility Rules',
            noRules: 'There are no visibility rules defined yet',
            allRules: 'Show lecture if it matches ALL of these rules:',
            anyRules: 'And matches ANY of these rules:',
            addRuleButton: 'Add Rule',
            addAndRuleButton: 'Add AND Rule',
            addOrRuleButton: 'Add OR Rule',
            whenText: 'When',
            operators: {
              QUESTIONS: {
                EQUALS: 'is',
              ...
              GROUPS: {
                ...
                NOT_CONTAINS: 'doesn\'t contain any'
              }
            },
            connectors: {
              AND: 'and',
        ...
        milestones: {
          ...
          description: 'Only one lecture per course can be marked.',
          alreadyAssigned: '<strong>{lectureName}</strong> is already marked',
          params: {
      ...
      addVideoHint: 'Alternatively, click "copy URL" on the video item in the library and paste it here.',
      videoSubtitles: 'Video subtitles',
      addVideoSubtitles: 'Add subtitles',
      editVideoSubtitles: 'Edit subtitles',
      addVideoSubtitlesTrack: 'Add subtitles track',
      videoSubtitlesLocale: 'Locale',
      ...
      saveBtn: 'Save',
      saveOnlyBtn: 'Save Only',
      saveAndNotifyBtn: 'Save and Notify Learners',
      saveAndNotifyDialog: {
        title: 'Save and Notify Learners',
        subtitle: 'Save the course and notify learners about recent updates.',
        notifyEveryone: 'Notify All',
        youAreAboutToNotify: 'No learners match the selected criteria for notification. | You are about to notify one learner. Click "Notify" to proceed. | You are about to notify {n} learners. Are you sure you want to continue?',
        youAreAboutToNotifyMany: 'No learners match the selected criteria for notification. | You are about to notify one learner. Click "Notify" to proceed. | You are about to notify {n} learners. Notifying more than 50 people might take up to 2 hours, as the messages are sent as part of an email campaign. Are you sure you want to continue?',
        notifyActive: 'Notify Active Learners',
        notifyGroup: 'Notify a Group',
        message: 'The course {courseName} has been updated. Please check the course for details.',
        messageTitle: 'Notification Message',
        messageLabel: 'Modify the default message if needed.',
        notifyAGroup: 'Notify a Specific Group',
        activeOrEveryoneTitle: 'Choose whether to notify only active learners or everyone, including those who have abandoned or completed the course.',
        activeOrEveryone: {
          active: 'Only Active Learners (Recommended)',
          everyone: 'All Learners'
        },
        toast: {
          success: 'Learners have been successfully notified about the updates.',
          error: 'An error occurred while notifying learners: {err}.'
        }
      },
      ...
      sections: {
        ...
        newHotspotImageSection: 'Hotspot Image',
        ...
        newHotspotImageSectionDescription: 'This section allows you to upload an image and add interactive hotspots simply by clicking on it. Each hotspot can include explanatory text, making your content more visual and engaging.',
        ...
        newTypeFormSectionDescription: 'Create an embedded TypeForm section',
        ...
        hotspotImage: {
          ...
          description: '<ul>' +
            '<li>Create an image with interactive points to reveal additional information.</li>' +
            '<li>Click on the image to add a hotspot with your text.</li>' +
            '<li>Hotspots can be moved or edited at any time.</li>' +
          '</ul>',
          editTitle: 'Edit Hotspot'
        }
      },
      tags: {
    ...
    progress: {
      courseNotStarted: 'Course not yet started',
      ...
      expiresOnTitle: 'Expires on',
      completedInTitle: 'Completed in',
      progressTitle: 'Quiz Progress',
      lectureProgressTitle: 'Lectures Progress',
      courseProgressTitle: 'Courses Progress',
      ...
      answeredQuestions: 'Answered <strong>{correct} / {total}</strong>',
      lecturesSeen: 'Lectures seen: <strong>{seen} / {total}</strong>',
      seen: 'Seen',
      lectureMarkedAsSeen: 'Marked as Seen',
      lectureIsNotMarkedAsSeen: 'Not Seen Yet',
      ...
      enrollCount: 'No enrolments | One enrolment | {n} enrolments',
      inactiveCount: 'Inactive: {n}',
      abandonedCount: 'Abandoned: {n}',
      runningCount: 'Active enrolments: {n}',
      finishedCount: 'Finished: {n}',
      noUsersInCourse: 'There are no users enrolled into this course.',
      noUsersSatisfyingFilter: 'There are no users satisfying given search or filter criteria',
      noQuestionsFound: 'No course questions found',
      ...
      tabs: {
        ...
        enrolledUsers: 'Overall Progress',
        questionAnswersProgress: 'Quiz Answers',
        pendingUsers: 'Pending Users',
        pendingGrading: 'Pending Grading',
        preCourseSurvey: 'Pre-Course Survey',
        postCourseSurvey: 'Post-Course Survey'
      },
      pendingGrading: {
        learnerTableTitle: 'Learner',
        actionsTableTitle: 'Actions',
        questionTableTitle: 'Question',
        answerTableTitle: 'Answer',
        fileTableTitle: 'File',
        noPendingGradingFound: 'No answers pending grading found.',
        feedbackTitle: 'Course Admin Feedback',
        feedbackFieldTitle: 'Provide/Change Feedback',
        openToGiveFeedback: 'Open to provide a feedback',
        changeFeedback: 'Change feedback'
      },
      questionAnswers: {
        questionTableTitle: 'Question',
        ...
        userAnswerTableTitle: 'User Answer'
      }
    },
    usersManagement: {
      ...
      sendInvitationToGroup: 'Invite {groupName}',
      invited: 'invited',
    ...
    staffManagement: {
      ...
      addUsers: 'Add Users',
      uploadUsersCSV: 'Or upload a CSV file <strong>(format: First Name, Last Name, Email, Group (optional))</strong>',
      ...
      inactivityPeriods: {
        ...
        TWOWEEKS: 'more than two weeks',
        MONTH: 'more than a month',
        HALFAYEAR: 'more than half a year',
      ...
      timeSpentLearningTitle: 'Time Spent Learning',
      ...
      userCard: {
        ...
        role: 'Role',
        group: 'Groups',
        timeSpentLearning: 'Overall time spent learning on {workspaceName}:',
      ...
      statuses: {
        ...
        archived: 'Archived',
        abandoned: 'Abandoned',
        inactiveUserExplanation: 'This user is not making any progress in one of the courses.'
      },
      ...
      inviteGroupUsersSuccessful: 'All the users of the group {name} were invited successfully',
      inviteUserError: 'There was an error inviting user {name}: {err}',
      inviteGroupUsersError: 'There was an error inviting the users of the group {name}: {err}',
    ...
    campaignManagement: {
      ...
      restrict: 'Restrict taking the course during...',
    ...
    integrationsManagement: {
      ...
      title: 'Integrations',
      autoSyncLabel: 'Turn on to synchronize daily, false otherwise.',
      ...
      oauth2IdPropertyLabel: 'OAuth2 ID Property',
      ...
      stripeDefaultTaxId: 'Stripe Default Tax Rate ID',
      stripeTaxationCountry: 'Stripe Taxation Country',
      useInvoicing: 'Use Invoicing',
      paymentMethodConfigurationId: 'Payment Method Configuration ID',
      ...
      xCmsLabel: 'xCms',
      deleteIntegration: 'Delete {name}',
      intercomAccessToken: 'Access Token',
      intercomAppId: 'App ID',
      intercomSecretKey: 'Secret Key',
      intercomChatEnabled: 'Enable Intercom Chat',
      categories: {
        HR: 'Human Resources',
        ...
        SOCIAL: 'Social',
        DEFAULT: 'Default',
        DEV: 'Development – Auth, Webhooks, Emails',
        CRM: 'CRM'
      },
      personio: {
        description: 'Sync users & groups. Auto-upload certificates to employee profiles.',
        explanation: '<ul>' +
        ...
        mappingInstructions: 'Map the values of Personio custom fields to Workademy groups.',
        fieldValuesLabel: 'Field Values (press space or tab to add)',
        fieldNamePlaceholder: 'Enter field name',
        valueInputPlaceholder: 'Type value and press space/tab',
        addFieldButton: 'Add Custom Field',
        certificateNameTemplateLabel: 'Certificate name template',
        certificateNameTemplateHint: 'Available variables: &#36;{userName}, &#36;{date}, &#36;{courseName}'
      },
      bamboo_hr: {
        description: 'Keep your team data aligned with user & group sync.',
      ...
      sage: {
        description: 'Sync users and reporting lines into Workademy.',
        explanation: 'Log in into your Sage admin account. The Subdomain is a part of the URL that represents your company, e.g. if it is company.sage.com, then subdomain is "company". Click on your profile picture, then select API Keys. Add new key and copy the value of API key here',
        syncSuccessful: 'Synchronization of users with Sage was successful. Go to users management console to review the invitations.',
        syncError: 'Synchronization of users with Sage was not successful. {err}',
        connectSuccessful: 'Successfully configured the integration with your Sage API',
        connectError: 'Error connecting to Sage. {err}',
        deleteSuccessful: 'Successfully deleted the integration with Sage API',
        deleteError: 'Error deleting the integration with Sage. {err}'
      },
      custom_oauth2: {
        description: '',
        explanation: '',
      ...
      oauth2: {
        ...
        postAuthCheckTitle: 'Post-Authentication Check',
        enablePostCheck: 'Enable post-authentication check',
        availableVarsTitle: 'Available Variables',
        addVarsLabel: 'Add variables from the OAuth2 response',
        varsPlaceholder: 'e.g. subscriptionStatus, accountType',
        varsHint: 'These variables will be available in the condition builder',
      ...
      push_notification: {
        description: '',
        explanation: 'Configure your webhooks endpoint here. ' +
          'Make sure your endpoint accepts Authorization “Basic”, the Content-Type “application/json” and the method “POST”.',
        connectSuccessful: 'Successfully configured the integration with your webhooks endpoint',
        syncError: 'Synchronization with webhooks endpoint was not successful. {err}',
        connectError: 'Error connecting to webhooks endpoint. {err}',
        deleteSuccessful: 'Successfully deleted the integration with webhooks endpoint',
        deleteError: 'Error deleting the integration with webhooks endpoint. {err}'
      },
      loom: {
        description: 'Embed and manage Loom videos directly in your courses.',
      ...
      disqus: {
        description: 'Add discussion threads and social interaction to your courses.',
      ...
      stripe: {
        description: 'Enable payments and automatic invoicing.',
        explanation: '<ol>\n' +
          '    <li>\n' +
          '      <strong>Publishable Key:</strong><br />\n' +
          '      Open your <a href="https://dashboard.stripe.com" target="_blank" class="tw-underline">Stripe Dashboard</a> and copy the <strong>Publishable Key</strong> from the API settings.\n' +
          '    </li>\n' +
          '    <li>\n' +
          '      <strong>Default Tax Rate ID:</strong><br />\n' +
          '      Navigate to the <a href="https://dashboard.stripe.com/tax-rates" target="_blank" class="tw-underline">Tax Rates section</a> in your Stripe dashboard.<br />\n' +
          '      - Copy an existing <strong>inclusive Tax Rate ID</strong>, or<br />\n' +
          '      - Create a new inclusive Tax Rate if needed.\n' +
          '    </li>\n' +
          '    <li>\n' +
          '      <strong>Taxation Country:</strong><br />\n' +
          '      Select the country where your entity is registered for tax purposes.<br />\n' +
          '      - Only users located in this country will be subject to taxes.\n' +
          '    </li>\n' +
          '  </ol>',
      ...
      liqpay: {
        description: 'Accept Ukrainian payments easily.',
      ...
      revolut: {
        description: 'Enable international payments with Revolut integration.',
      ...
      open_ai: {
        description: 'Generate course content using your OpenAI account.',
      ...
      people_force: {
        description: 'Sync employee records and structure directly.',
      ...
      rippling: {
        description: 'Automate user and group management with ease.',
      ...
      deel: {
        description: 'Sync distributed teams seamlessly.',
      ...
      monobank: {
        description: 'Connect Monobank for local payment flow.',
        explanation: 'Open your Monobank dashboard and copy your xToken and xCms if applicable.',
      ...
      hi_bob: {
        description: 'Keep people and permissions in sync effortlessly.',
      ...
      alexis_hr: {
        description: 'Align users & roles from your HR core.',
        explanation: 'Log in into your AlexisHR dashboard and copy your clientSecret keys.',
        syncSuccessful: 'Synchronization of users with AlexisHR was successful. Go to users management console to review the invitations.',
        syncError: 'Synchronization of users with AlexisHR was not successful. {err}',
        connectSuccessful: 'Successfully configured the integration with your AlexisHR API',
        connectError: 'Error connecting to AlexisHR. {err}',
        deleteSuccessful: 'Successfully deleted the integration with AlexisHR API',
        deleteError: 'Error deleting the integration with AlexisHR. {err}'
      },
      brevo: {
        description: 'Engage learners with automated CRM campaigns.',
        eventTemplateMappingLabel: 'Template Mapping',
        eventTemplateMappingDescription: 'Map Workademy events to your Brevo templates by entering the corresponding Brevo template IDs.',
        explanation: 'Log in to your <strong><u><a href="https://app.brevo.com/settings/keys/api" target="_blank">Brevo dashboard</a></u></strong> and copy your API key.',
        syncSuccessful: 'Synchronization with Brevo successful.',
        syncError: 'Synchronization of with Brevo was not successful. {err}',
        connectSuccessful: 'Successfully configured the integration with your Brevo account',
        connectError: 'Error connecting to Brevo. {err}',
        deleteSuccessful: 'Successfully deleted the integration with Brevo',
        deleteError: 'Error deleting the integration with Brevo. {err}',
        templateMappingExplanation: 'Template IDs can be found in your <strong><u><a href="https://app.brevo.com/templates/listing" target="_blank">Brevo account</a></u></strong> under the Email Templates section',
        defaultEmailsWhenNoMapping: 'Apply default emails when there\'s no mapping (recommended).',
        templateMappingHeaders: {
          lmsTemplate: 'Workademy Events',
          audience: 'Audience',
          description: 'Description',
          brevoTemplateID: 'Brevo Template ID'
        },
        ...
        templateMapping: {
          check_user_courses_notification_event: {
            ...
            description: 'Sent to learner when notifying them of inactivity'
          },
          new_open_ended_question_answered_event: {
            title: 'New open-ended answer',
            description: 'Notification to an admin when a learner submits an open-ended answer'
          },
          new_open_ended_question_graded_event: {
            title: 'New open-ended question graded',
            description: 'Alerts learner when their open-ended question is graded'
          },
          pending_user_course_approval_event: {
            title: 'Enrollment pending',
            description: 'Notifies admin of pending course enrollment'
          },
          registration_event: {
          ...
          user_course_assigned_event: {
            ...
            description: 'Notifies learner of new course assignment'
          },
          user_learning_path_assigned_event: {
            title: 'New learning path assignment',
            description: 'Notifies learner of new learning path assignment'
          },
          workspace_invitation_event: {
            title: 'Invitation to join workspace',
            description: 'Sent when user is invited to join a workspace'
          }
        }
      },
      intercom: {
        description: 'Chat, onboard, and perform segmentations based on user interactions.',
        explanation: '<div tw-leading-[1.5]><div class="tw-mb-3">To integrate with Intercom, follow these essential steps:</div>' +
          '<div class="tw-mb-1.5"><strong>1.</strong> Create an App in Intercom <br>Visit Settings > Integrations > Intercom Developer Hub and create an app to enable API access. After creating the app, you will obtain an Access Token.</div>' +
          '<div class="tw-mb-1.5"><strong>2.</strong> Install Intercom Messenger on Your Website <br>Visit Settings > Channels > Messenger > Install and copy the appId from the code samples.</div>' +
          '<div class="tw-mb-1.5"><strong>3.</strong> Obtain the Web Identity Secret <br>This can be found in the Install section under Identity Verification.</div></div>',
        syncSuccessful: 'Sync with Intercom successful.',
        syncError: 'Sync with Intercom not successful. {err}',
        connectSuccessful: 'Integration with Intercom successful!',
        connectError: 'Error while connecting to Intercom. {err}',
        deleteSuccessful: 'Successfully deleted the integration with Intercom.',
        deleteError: 'Error deleting the integration with Intercom. {err}'
      },
      salesforce_mc: {
        description: 'Salesforce Marketing Cloud',
        explanation: 'Send automated personalized transactional emails with Workademy using your Salesforce Marketing Cloud account.',
        syncSuccessful: 'Sync with Salesforce Marketing Cloud successful.',
        syncError: 'Sync with Salesforce Marketing Cloud not successful. {err}',
        connectSuccessful: 'Integration with Salesforce Marketing Cloud successful!',
        connectError: 'Error while connecting to Salesforce Marketing Cloud. {err}',
        deleteSuccessful: 'Successfully deleted the integration with Salesforce Marketing Cloud.',
        deleteError: 'Error deleting the integration with Salesforce Marketing Cloud. {err}',
        subdomainLabel: 'Subdomain',
        templateMapping: {
          welcome_to_course_event: {
            title: 'Welcome to course event',
            description: 'Welcome to course event'
          }
        },
        templateMappingHeaders: {
          salesforceTemplateID: 'Template ID'
        }
      }
    },
      ...
      tabs: {
        general: {
          ...
          workspaceName: {
            ...
            subtitle: 'Set or edit the workspace name.',
            label: 'Type workspace name',
            rules: {
              required: 'Name is required',
              lessThan: 'Name must be less than 64 characters',
              invalidCharacters: 'Special characters are not allowed'
            }
          },
          language: {
            title: 'Default Language',
            subtitle: 'Configure the default language for the workspace.',
            label: 'Choose default language'
          },
          privacySettings: {
            title: 'Workspace Privacy Settings',
            subtitle: 'Control whether the workspace is public and can be indexed by search engines.',
            label: 'Public workspace'
          },
          inviteOnly: {
            title: 'Workspace Joining Options',
            subtitle: 'Set whether the workspace is open for anyone to join or if it\'s by invitation only.',
            label: 'Invite only'
          }
        },
        apiKeys: {
          title: 'API Key',
          noApiKeys: 'You don\'t have an API key yet',
          errorCreating: 'Error creating API key: {error}',
          errorDeleting: 'Error deleting API key: {error}',
          copySuccessful: 'API key copied successfully.',
          copyError: 'API key could not be copied: {error}',
          createApiKeyButton: 'Create API Key Now',
          removeApiKeyButton: 'Remove API Key'
        },
        userInteraction: {
        ...
        seoMetadata: {
          title: 'SEO & Metadata',
          subtitle: 'Manage meta tags for search engines and social sharing (e.g., OpenGraph, Twitter cards).',
          pageTitleLabel: 'Page title',
          pageKeywordsLabel: 'Page keywords',
          pageDescriptionLabel: 'Description',
          twitter: {
            title: 'Twitter/X',
            titleLabel: 'Twitter Title',
            descriptionLabel: 'Description'
          },
          opengraph: {
            title: 'OpenGraph',
            titleLabel: 'OpenGraph Title',
            descriptionLabel: 'OpenGraph Description'
          },
          rules: {
            maxChars: 'Max {characters} characters',
            alphaNumericSpacePunctuation: 'Only alphanumeric characters, spaces, and punctuation marks are allowed',
            alphaNumericCommasSpaces: 'Only alphanumeric characters, commas, and spaces are allowed',
            alphaNumericCommasSpacesPipe: 'Only alphanumeric characters, spaces, and symbols |, - are allowed',
            alphaNumericCommasSpacesPipeDash: 'Only alphanumeric characters, spaces, and symbols |, -, : are allowed',
            invalidOpenGraphImage: 'The uploaded image must be in one of the following formats: JPG, PNG, or GIF'
          }
        },
        popups: {
          title: 'Pop-ups',
    ...
    library: {
      ...
      maxSizeAllFiles: 'PDFs must not exceed {pdfSize}MB, videos – {videoSize}MB, others – {fileSize}MB',
      maxSizeNormalFiles: 'Each file must not exceed {fileSize}MB',
      fileTypeWithArticle: {
        IMAGE: 'an image',
        PDF: 'a pdf',
        MP3: 'an MP3',
      ...
      fileName: 'File name',
      category: 'Category',
      updatingFile: 'Updating file everywhere',
      categories: {
        ALL: 'All',
        AVATAR: 'Avatar',
        COVER_IMAGE: 'Covers',
      ...
      errors: {
        ...
        pdfSize: 'PDF files should not exceed {size} in size',
        mp4Size: 'MP4 files should not exceed {size} in size',
      ...
      libraryItemTooltip: '<h6>{name}</h6><hr><div class="caption">Click to copy the URL.</div>',
      showCourseFiles: 'The files displayed were uploaded inside the current course. Toggle the button to see all the files in the workspace.',
      showWorkspaceFiles: 'All the files from the workspace are displayed. Untoggle the button to see only the files that were uploaded within the current course.',
      showWorkspaceFilesToggleButton: 'Show All Workspace Files'
    },
    sectionsLibrary: {
      title: 'Sections',
    ...
    learningPaths: {
      ...
      stepper: {
        ...
        titleErrorMessage: 'Learning Path Name is required',
        ...
        info: {
          ...
          certifiable: 'Enable certificate in the end of the learning path.',
          timing: {
            title: 'Manage Timing for Your Learning Path',
            description: 'Configure the timing settings for your learning path. Specify the number of days to send reminders for inactivity and the maximum allowed duration for completion before automatic cancellation. Only Learning Paths started after this setting will be considered.',
            reminderAfterInactivity: {
              title: 'Send a Reminder After Inactivity',
              description: 'Automatically send a reminder to learners if they haven’t completed the learning path within [N days] from the start date. Keep learners engaged with timely nudges.',
              label: 'Days Until Reminder',
              tooltip: 'Enter the number of days after the start date to send a reminder for incomplete learning paths.'
            },
            automaticCancellationTime: {
              title: 'Set Completion Deadline',
              description: 'Define the maximum time (in days) allowed to complete the learning path. If the learner does not finish within [N days] from the start date, the learning path will be automatically canceled. Only Learning Paths started after this setting will be considered.',
              label: 'Days Until Cancellation',
              tooltip: 'Enter the maximum number of days allowed to complete the learning path. After this period, it will be automatically canceled.'
            },
            automaticRetake: {
              title: 'Automatic Retake',
              description: 'Automatically retake the learning path (if not started already) after a certain amount of time since it was last started.',
              retakeErrorMessage: 'Completion deadline must be less than the retake period.',
              labelValue: 'Time value',
              labelUnit: 'Time unit'
            }
          }
        },
    ...
    groups: {
      ...
      stepper: {
        ...
        info: {
          ...
          description: 'Add description of the group here. It is possible to change it in the future.',
    ...
    folders: {
      ...
      stepper: {
        ...
        info: {
          ...
          courses: 'Add courses to the folder'
        },
    ...
    dialogs: {
      courseOwnersTitle: 'Course Owners and Editors',
      courseOwnersTable: {
        username: 'User Email',
        role: 'Role',
        creatorRole: 'Creator',
      ...
      enrollButton: {
        text: 'Enroll',
        title: {
          course: 'Enroll Non-Enrolled Users to Course',
          learningPath: 'Enroll Non-Enrolled Users to Learning Path'
        }
      },
      enrollNowButton: {
        text: 'Enroll now!',
      ...
      checkProgress: {
        text: 'Check Progress',
        title: {
          course: 'Check Learner\'s Progress on Course',
          learningPath: 'Check Learner\'s Progress on Learning Path'
        }
      },
      assignButton: {
        text: 'Associate',
      ...
      addAdminButton: {
        text: 'Add as Editor',
        title: {
          courseAdmins: 'Add the User as a Course Editor'
        }
      },
      removeAdminButton: {
        text: 'Remove Editor Role',
        title: {
          courseAdmins: 'Remove the User as a Course Editor'
        }
      },
      explanationGroups: {
      ...
      explanationUsers: {
        ...
        courseAdmins: 'Click on the <strong>Add as Editor</strong> button to make a user the course admin.' +
          '<br>Click on the <strong>Remove Editor Role</strong> button to remove a user from the course admins list.'
      },
      enrollUsersTitle: 'Enroll Users',
      enrollGroupsTitle: 'Enroll Groups',
      addCourseAdminsTitle: 'Add Course Editors',
      status: {
        groupAssociated: {
          success: {
        ...
        folderAdded: {
          success: {
            course: 'The course has been successfully added to the folder {name}.'
          },
          error: {
            course: 'There was an error adding the course to the folder {name}: {err}.'
          }
        },
        folderRemoved: {
          success: {
            course: 'The course has been successfully removed from the folder {name}.'
          },
          error: {
            course: 'There was an error removing the course from the folder {name}: {err}.'
          }
        },
        groupEnrolled: {
          success: {
    ...
    cloneOrShare: {
      ...
      title: 'Clone or Share Course',
      toCurrentWorkspace: 'Clone {name} to the current workspace',
      toOtherWorkspace: 'Clone {name} to another workspace',
      chooseWorkspace: 'Choose the workspace to clone or share the course',
      cloneCourseExplanation: '<strong>Clone</strong> {courseName} to {workspaceName} workspace: the course will be cloned and managed on {workspaceName} workspace.',
      shareCourseExplanation: '<strong>Share</strong> {courseName} to {workspaceName} workspace: the course will be shared to {workspaceName}. Any changes introduced on the current workspace will be propagated to {workspaceName} workspace.',
      cloneButton: 'Clone Course',
      shareButton: 'Share Course',
      cloningCourseOverlay: 'The course {name} is being cloned...',
      sharingCourseOverlay: 'The course {name} is being shared...',
      courseCloneSuccess: 'The course {name} is cloned successfully.',
      courseCloneError: 'There was an error cloning course {name}: {err}.',
      courseShareSuccess: 'The course {name} is shared successfully.',
      courseShareError: 'There was an error sharing course {name}: {err}.'
    },
    translateCourse: {
      title: 'Translate Course',
      languageLabel: 'Choose Language',
      contextLabel: 'Provide Some Context or Instructions',
      translateButtonLabel: 'Translate',
      overlayText: 'The course {name} is being translated. It will take some time. You can close this window and you will be notified when the translation is done.',
      warning: 'Please note that this is a <strong>BETA</strong> feature. Some lessons, especially in <strong>large courses</strong>, may not be translated accurately. Therefore, a human check will always be necessary.'
    }
  },
  analytics: {
  ...
  header: {
    menu: {
      ...
      profileSubtitle: {
        ...
        courseEditorViewNonAdmin: 'Course editor<br><span class="caption">(viewing as a student)</span>'
      },
      create: {
        course: 'Course',
  ...
  preCourseSurvey: {
    ...
    subtitleNotStarted: 'Please fill this survey. After filling it you will be able to start the course!',
    subtitleFinished: 'You can change the answer to your pre-course survey.',
    subtitleEditing: 'Edit the pre-course survey.',
    editSurveyButton: 'Edit',
    finishEditSurveyButton: 'Done Editing',
    buttonTitle: 'Pre-Course Survey',
    addNewSurveyQuestion: 'Add New Survey Question',
    editCourseSurvey: 'In this section you can add or edit a mandatory course survey. ' +
      'This survey will appear as a pop-up to the learners before they can start the course.',
    fillCourseSurvey: 'You must finish the survey before you proceeding to the course.',
    fillEditCourseSurvey: 'You can edit your answers to the course survey.',
    filters: {
      button: 'Filter by Questions',
      title: 'Filter By Course Questions and Answers',
  ...
  postCourseSurvey: {
    ...
    subtitleNotStarted: 'Please fill this survey. After filling it you will be able to finish the course!',
    subtitleFinished: 'You can change the answer to your post-course survey.',
    subtitleEditing: 'Edit the post-course survey.',
    editSurveyButton: 'Edit',
    finishEditSurveyButton: 'Done Editing',
    buttonTitle: 'Post-Course Survey',
    addNewSurveyQuestion: 'Add New Survey Question',
    editCourseSurvey: 'In this section you can add or edit a mandatory post-course survey. ' +
      'This survey will appear as a pop-up to the learners before they can get their certificate or finish the course.',
    fillCourseSurvey: 'You must finish the survey before being able to finish the course.',
    fillEditCourseSurvey: 'You can edit your answers to the course survey.'
  },
  getReadyAi: {
    title: 'Create your Course with AI',
    description: 'Type your email and course topic and we will email you the link to your AI-generated course.',
    usernameLabel: 'Your Email',
    courseTopicLabel: 'Course Topic',
    generateButton: 'Create my Course',
    afterGenerateButton: 'Click on the above button and you will get an email soon.',
    topicRequired: 'Topic is required',
    setPasswordTitle: 'Set your Password',
    setPasswordDesc: 'After setting your password, you will be redirected to your course.',
    setPasswordButton: 'Set Password and Log In',
    tokenLabel: 'Token',
    passwordLabel: 'Password',
    courseCreationRequestSuccess: 'Your course is now being created. ' +
      'You can leave this page now. ' +
      'You will get an email as soon as your course is finished!'
  },
  meta: {
    titles: {
      pages: {
        ...
        signin: 'Signin',
        learnerProfile: 'Learner Profile',
        onboardingWithAi: 'Onboarding with AI',
        organization: 'Organization',
        paswordreset: 'Reset Password',
        printableCourse: 'Printable Course'
      }
    }
  },
  ocid: {
    connect: 'Connect OC-ID',
    reconnect: 'Reconnect OC-ID',
    yourOCID: 'Your OC-ID: <strong><a href="{url}" target="_blank">{ocid}</a></strong>',
    connectionSuccess: 'Connection with OC-ID successful',
    reconnectionSuccess: 'Reconnection with OC-ID successful',
    connectionError: 'There was an error in connecting with OC-ID: {err}',
    reconnectionError: 'There was an error in reconnecting with OC-ID: {err}'
  }
}
